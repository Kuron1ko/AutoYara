...
from configs.config import get_openai_api_key, get_openai_base_url  # noqa: E402
...
def test_sync_client():
    ...
    base_url = get_openai_base_url().strip() or None
    if not api_key:
    ...
    client = SyncLLMClient(api_key=api_key, base_url=base_url)
